...
# Run MySQL command with root user and password
sudo mysql -u root -p{$STORAGE_PASS} -e "
CREATE DATABASE slurm_acct_db;
CREATE USER 'slurm'@'localhost' IDENTIFIED BY '${STORAGE_PASS}';
...
echo "Installing SLURM Database Daemon"
